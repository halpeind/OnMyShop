...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>OnMyShop</title>

        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Raleway:100,600" rel="stylesheet" type="text/css">
        <!-- Styles -->
        <link rel="stylesheet" type="text/css" href="respurces/assets/css/style.css">
        <style>
        .jumbotron {
          margin-top: 20px;
          background-image: url("http://storage.jurnalotaku.com/wp-content/uploads/2017/07/JOI-waifu-wednesday-tamamo-no-mae-1.jpg");
    ...
    <div class="container-fluid">
          <div class="jumbotron">
              <h1 class="display-3">OnMyShop</h1>
              <p class="lead">You come, You pick, You buy</p>
          </div>
          <div>
              ...
              <div class="container">
                <div class="row row1">
                  <ul class="largenav pull-right">
                    <li class="upper-links"><a class="links" href="http://clashhacks.in/">Login/Sign up</a></li>
                ...
                <div class="row row2">
                  <div class="col-sm-2">
                    ...
                    <h1 style="margin:0px;" align="left"><span class="largenav">OnMyShop</span></h1>
                  </div>
